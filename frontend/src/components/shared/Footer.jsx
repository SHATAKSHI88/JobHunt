        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          <div className="max-w-sm">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-heading text-lg font-extrabold">Job<span className="text-primary">Hunt</span></span>
            </Link>
            <p className="text-sm text-muted-foreground mt-3">
              Connecting candidates with the right roles, and recruiters with the right people.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
            <div>
              <h3 className="font-semibold mb-3 text-foreground">For candidates</h3>
              <ul className="flex flex-col gap-2 text-muted-foreground">
                <li><Link to="/jobs" className="hover:text-foreground transition-colors">Browse jobs</Link></li>
                <li><Link to="/browse" className="hover:text-foreground transition-colors">Search</Link></li>
                <li><Link to="/profile" className="hover:text-foreground transition-colors">Your profile</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-3 text-foreground">For recruiters</h3>
              <ul className="flex flex-col gap-2 text-muted-foreground">
                <li><Link to="/admin/companies" className="hover:text-foreground transition-colors">Companies</Link></li>
                <li><Link to="/admin/jobs" className="hover:text-foreground transition-colors">Post a job</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-3 text-foreground">Follow</h3>
